...
namespace argo {
	...
	namespace backend {
		...
		namespace atomic {
			 ...
			 *       It is used perform stores on the owners_dir_window window.
			 * @warning For internal use only - DO NOT USE UNLESS YOU KNOW WHAT YOU ARE DOING
			 */
			 ...
			 * @sa store to private window section
			 * @note Implementation-specific function for the first-touch data distribution.
			 *       It is used perform stores on the offsets_tbl_window window.
			 * @warning For internal use only - DO NOT USE UNLESS YOU KNOW WHAT YOU ARE DOING
			 */
			 ...
			 * @note Implementation-specific function for the first-touch data distribution.
			 *       It is used perform loads on the owners_dir_window window.
			 * @warning For internal use only - DO NOT USE UNLESS YOU KNOW WHAT YOU ARE DOING
			 */
			 ...
			 * @sa load from private window section
			 * @note Implementation-specific function for the first-touch data distribution.
			 *       It is used perform loads on the offsets_tbl_window window.
			 * @warning For internal use only - DO NOT USE UNLESS YOU KNOW WHAT YOU ARE DOING
			 */
			 ...
			 * @sa compare_exchange
			 * @note Implementation-specific function for the first-touch data distribution.
			 *       It is used perform CAS on the owners_dir_window window.
			 * @warning For internal use only - DO NOT USE UNLESS YOU KNOW WHAT YOU ARE DOING
			 */
			 ...
			 * @sa compare_exchange
			 * @note Implementation-specific function for the first-touch data distribution.
			 *       It is used perform CAS on the offsets_tbl_window window.
			 * @warning For internal use only - DO NOT USE UNLESS YOU KNOW WHAT YOU ARE DOING
			 */
