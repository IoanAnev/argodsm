 ...
 *        a node-wide barrier
 */
TEST_F(backendTest, randIndicesBarrierArray) {
	// Allocate global array
	const std::size_t array_size = 1048576;
	int* array = argo::conew_array<int>(array_size);

	// Allocate indice array and populate it
	std::vector<int> rand_index(array_size);
	std::iota(rand_index.begin(), rand_index.end(), 0);

	// Randomly shuffle the values of indice array
	...
	const std::size_t expected = ((array_size - 1) * array_size) / 2;
 ...
 */
TEST_F(backendTest, randIndicesBulkySelectiveReleaseAcquireArray) {
	// Allocate global array
	const std::size_t array_size = 1048576;
	int* array = argo::conew_array<int>(array_size);
 ...
 */
TEST_F(backendTest, randIndicesPeriodicSelectiveReleaseAcquireArray) {
	// Allocate global array
	const std::size_t array_size = 1048576;
	int* array = argo::conew_array<int>(array_size);
 ...
 *        a node-wide barrier
 */
TEST_F(backendTest, randIndicesBarrierPage) {
	// Allocate global page
	const std::size_t array_size = 4096 / sizeof(int);
	int* array = argo::conew_array<int>(array_size);
 ...
 *        one bulky selective_release and an acquire
 */
TEST_F(backendTest, randIndicesBulkySelectiveReleaseAcquirePage) {
	// Allocate global page
	const std::size_t array_size = 4096 / sizeof(int);
	int* array = argo::conew_array<int>(array_size);
 ...
 *        periodic selective_release and an acquire
 */
TEST_F(backendTest, randIndicesPeriodicSelectiveReleaseAcquirePage) {
	// Allocate global page
	const std::size_t array_size = 4096 / sizeof(int);
	int* array = argo::conew_array<int>(array_size);
